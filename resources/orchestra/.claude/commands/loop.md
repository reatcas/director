...
## BOOT
1. `date`. Re-read `.claude/orchestra.json`. Read last cycle PLAN.md only. DECISIONS.md+PENDING.md. Shared memory INDEX.md. Read `.claude/PRODUCT_DIRECTIVE.md` if exists. Read `.claude/A11Y_TREE.md` if exists. Read `.claude/DB_SCHEMA.md` if exists.
